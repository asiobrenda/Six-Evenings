...
BASE_DIR = Path(__file__).resolve().parent.parent  #/home/asio/projects1/MakeUp/makeup/makeup
MAK_DIR = os.path.dirname(BASE_DIR)           #/home/asio/projects1/MakeUp/makeup
